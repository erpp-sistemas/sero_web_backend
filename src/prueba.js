...
const logoPath = `https://www.ser0.mx/ser0/image/SER0_logo_blanco.png`;
...
const sendTestEmail = async (to) => {
  ...
  <body>
    <div class="container">
      ...
      <ul>
        <li><strong>Usuario:</strong> {{1}} 👤</li>
        <li><strong>Contraseña:</strong> {{2}} 🔐</li>
        <li><strong>Rol:</strong> {{3}} 🌐</li>
      </ul>
      <hr>
      <p>Detalles adicionales:</p>
      <ul>
        <li><strong>Nombre Completo:</strong> {{4}} 💼</li>
        <li><strong>Fecha de Nacimiento:</strong> {{5}} 🎂</li>
        <li><strong>Correo Electrónico:</strong> {{6}} 📧</li>
        <li><strong>Número de Teléfono:</strong> {{7}} ☎️</li>
      </ul>
      <hr>
...
sendTestEmail(["arturo.chavez@erpp.mx","carlos.martinez@erpp.mx"]);
